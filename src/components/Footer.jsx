...
import { Github, Twitter, Linkedin, Mail, ArrowUpRight, Zap, Target, Shield, Download, Smartphone } from 'lucide-react';
        ...
        <footer className="bg-[#020202] border-t border-white/5 pt-20 pb-10 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        <h4 className="text-white font-black mb-6 uppercase text-[10px] tracking-[0.4em] italic flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-500 text-xs font-bold uppercase tracking-widest">
                            <li>
                                ...
                                >
                                    FarmerOne APK <Download size={10} className="opacity-0 group-hover:opacity-100 transition-opacity" />
                                </a>
                            </li>
                            <li><a href="#" className="hover:text-indigo-400 transition-colors">iOS (Coming Soon)</a></li>
                        </ul>
                    </div>
                </div>
